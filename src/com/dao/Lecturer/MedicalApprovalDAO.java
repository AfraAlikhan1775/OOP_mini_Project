    ...
    public List<LecturerMedicalRequest> getMedicalRequestsForLecturer(String lecturerEmpId) {
        ...
        String sql = """
            SELECT
                ...
                COALESCE(mss.medical_for, 'ATTENDANCE') AS medical_for,
                mss.course_id,
                mss.session_id,
                mss.session_name,
                mss.type,
    ...
    public boolean approveMedical(int medicalId, String lecturerEmpId) {
        ...
        try (Connection conn = DatabaseInitializer.getConnection()) {
            ...
            try (PreparedStatement p1 = conn.prepareStatement(updateMedical);
                 PreparedStatement p2 = conn.prepareStatement(updateSelected);
                 PreparedStatement p3 = conn.prepareStatement(updateAttendanceOnly)) {
